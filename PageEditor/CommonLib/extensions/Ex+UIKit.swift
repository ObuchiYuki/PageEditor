...
extension UIAlertController{
    func addCancel(_ completion: (() -> Void )? = nil){
        self.addAction(UIAlertAction(title: "キャンセル", style: .cancel){_ in completion?()})
    }
    func addAction(
        title:String,subTitle:String? = nil,style:UIAlertAction.Style = .default,image:UIImage? = nil,titleAlignment:NSTextAlignment? = nil,_ handler:@escaping ()->Void
    ){
